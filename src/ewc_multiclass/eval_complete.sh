...
CKPT_FILE0=../../models/incremental/binary_ewc_convfix.h5
...
#CKPT=../../models/incremental/multiclass/ewc
#CKPT_FILE0=../../models/incremental/incremental1-ewc.h5
#CKPT_FILE1=$CKPT/weights_multiclass_ewc.50-1.82.hdf5
#CKPT_FILE2=$CKPT/weights_multiclass_ewc90.50-1.87.hdf5
#CKPT_FILE3=$CKPT/weights_multiclass_v2_ewc.50-1.85.hdf5
#CKPT_FILE4=$CKPT/weights_multiclass_v2_ewc95.50-1.85.hdf5
#CKPT_FILE5=$CKPT/weights_multiclass_smaller_ewc.50-1.42.hdf5
CKPT_STRING=$CKPT_FILE0,$CKPT_FILE1,$CKPT_FILE2,$CKPT_FILE3,$CKPT_FILE4,$CKPT_FILE5
...
INCREMENTAL_TRAIN_REPORT=5class_ensemble_incremental_ewc.json
INCREMENTAL_TRAIN_ROC=5class_ensemble_incremental_ewc.png
