...
CKPT=../../models/incremental/modelv1-KaggleDRD-50ep-incremental1-weight-transfer.h5
LOG=losses_1.txt
...
python incremental_weight_transfer.py --train_dir $TRAIN_DIR --validation_dir $VAL_DIR --prev_model $PREV_MODEL --num_epochs $EPOCHS --batch_size $BATCH_SIZE --image_height $IMAGE_HEIGHT --image_width $IMAGE_WIDTH --checkpoint_file $CKPT --log_file $LOG
