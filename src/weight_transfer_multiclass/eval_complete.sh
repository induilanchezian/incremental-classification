...
CKPT_FILE0=../../models/incremental/incremental1-weight-transfer.h5
...
INCREMENTAL_TRAIN_REPORT=multiclass_ensemble_incremental_ewc_5class.json
INCREMENTAL_TRAIN_ROC=multiclass_ensemble_incremental_ewc_5class.png
