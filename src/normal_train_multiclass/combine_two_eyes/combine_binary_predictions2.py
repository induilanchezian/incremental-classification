...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_file', type=str, help='Path of file where predictions are stored. Filename with .npy extension')
    ...
    features = []
    ckpt = '/media/indu/New Volume/models/base/modelv5-KaggleDRD-50ep-base.h5'
    ...
    np.save(args.pred_file, features)
