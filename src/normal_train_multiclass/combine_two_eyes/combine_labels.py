...
if __name__ == '__main__':
    ...
    parser.add_argument('--left_file', type=str, help='Path of file where features are stored. Filename with .npy extension')
    parser.add_argument('--right_file', type=str, help='Path of file where labels are stored. Filename with .npy extension')
    ...
    for fname in files_list:
        ...
        if comp_file in files_list:
            ...
            labels_left.append(left_label)
            labels_right.append(right_label)
    ...
    np.save(args.left_file, labels_left)
    np.save(args.right_file, labels_right)
