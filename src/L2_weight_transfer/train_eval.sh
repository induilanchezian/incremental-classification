...
CKPT=../../models/incremental/modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer.h5
LOG=losses_1.txt

REPORT=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-test.json
ROC=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-test.png

TRAIN_REPORT=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-inc1-train.json
TRAIN_ROC=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-inc1-train.png

BASE_TRAIN_REPORT=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-base-train.json
BASE_TRAIN_ROC=modelv1-KaggleDRD-50ep-incremental1-l2weight-transfer-base-train.png
